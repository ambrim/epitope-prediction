...
model_checkpoint = "ambrim/finetuned-epitope_attempt7_150M_200k_default_accuracy"
...
args = TrainingArguments(
    f"{model_name}-finetuned-epitope_attempt7_150M_200k_default_accuracy_more", # 93% 0, 7$ 1
